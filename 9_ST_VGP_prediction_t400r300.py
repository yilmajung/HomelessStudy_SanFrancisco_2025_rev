...
scaler = joblib.load('scaler_pois_velbo_t400r300.joblib')
constant_mean = joblib.load('constant_mean_velbo_t400r300.pkl')
inducing_points = torch.load('inducing_points_pois_velbo_t400r300.pt', map_location=device)
...
# save results
df_daily.to_csv('st_vgp_pois_constmean_t400r300_daily_totals.csv', index=False)
df_test.to_csv('st_vgp_pois_constmean_t400r300_test_predictions.csv', index=False)
