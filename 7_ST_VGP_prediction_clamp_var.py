...
z95        = 1.96
z90        = 1.645
LOG_MIN    = -3.0   # lower clamp on log-rate
LOG_MAX    =  3.0   # upper clamp on log-rate
...
# Save results
df_test.to_csv('~/HomelessStudy_SanFrancisco_2025_rev_ISTServer/prediction_poisson_ip700_rev3.csv', index=False)
print("Prediction complete. Results saved to 'prediction_poisson_ip700_rev3.csv'.")
