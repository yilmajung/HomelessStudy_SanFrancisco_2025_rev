...
# Save
torch.save(model.state_dict(), 'stvgp_pois_constmean2.pth')
torch.save(likelihood.state_dict(), 'likelihood_pois_constmean2.pth')
torch.save(inducing_points, 'inducing_points_pois_constmean2.pt')
