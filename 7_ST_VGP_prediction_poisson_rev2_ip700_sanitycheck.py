...
# Save results
df_test.to_csv('~/HomelessStudy_SanFrancisco_2025_rev_ISTServer/prediction_poisson_lr001_rev2_ip700_sanitycheck.csv', index=False)
print("Prediction complete. Results saved to 'prediction_poisson_lr001_rev2_ip700_sanitycheck.csv'.")
