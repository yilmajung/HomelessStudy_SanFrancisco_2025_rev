...
# Save the model
print("Saving model...")
torch.save(model.state_dict(), 'stvgp_model_nb_300.pth')
torch.save(likelihood.state_dict(), 'stvgp_likelihood_nb_300.pth')
joblib.dump(scaler, 'scaler_nb_300.pkl')

# Save inducing points
print("Saving inducing points...")
torch.save(inducing_points, 'inducing_points_nb_300.pt')