...
# Save the model
print("Saving model...")
torch.save(model.state_dict(), 'stvgp_model_nb_500.pth')
torch.save(likelihood.state_dict(), 'stvgp_likelihood_nb_500.pth')
joblib.dump(scaler, 'scaler_nb_500.pkl')

# Save inducing points
print("Saving inducing points...")
torch.save(inducing_points, 'inducing_points_nb_500.pt')