...
# Save results
df_test.to_csv('~/HomelessStudy_SanFrancisco_2025_rev_ISTServer/sanity_check_results.csv', index=False)
print("Sanity check complete. Results saved to 'sanity_check_results.csv'.")
