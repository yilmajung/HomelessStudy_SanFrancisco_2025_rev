...
# Save
torch.save(model.state_dict(), 'stvgp_constmean.pth')
torch.save(likelihood.state_dict(), 'likelihood_constmean.pth')
torch.save(inducing_points, 'inducing_points_constmean.pt')
