...
scaler = joblib.load('scaler_pois_constmean_lr01.joblib')
constant_mean = joblib.load('constant_mean_pois_lr01.pkl')
inducing_points = torch.load('inducing_points_pois_constmean_lr01.pt', map_location=device)
...
likelihood.load_state_dict(torch.load('likelihood_pois_constmean_lr01.pth', map_location=device))
...
# # Save results
# df_test.to_csv('~/HomelessStudy_SanFrancisco_2025_rev_ISTServer/prediction_poisson_lr01.csv', index=False)
# print("Prediction complete. Results saved to 'prediction_poisson_lr01.csv'.")
