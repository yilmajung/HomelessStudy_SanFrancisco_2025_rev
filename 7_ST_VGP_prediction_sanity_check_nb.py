...
inducing_points = torch.load('inducing_points_nb.pt', map_location=device)
...
model.load_state_dict(torch.load('stvgp_model_nb.pth', map_location=device))
likelihood.load_state_dict(torch.load('stvgp_likelihood_nb.pth', map_location=device))
